...
// Outbox++
#include "apptimate/outbox/callback.hpp"
#include "apptimate/outbox/filter.hpp"
#include "apptimate/outbox/inbox.hpp"
#include "apptimate/outbox/outbox.hpp"
...
namespace apptimate {
    namespace cryptobox {
        class Cryptobox {
        public:
            using CryptoFailureCallback = std::function<void(const apptimate::Exception&)>;
            ...
            void putUsingLongTermKeys(const std::string& to,
                                      ...
                                      const Values& options = Values(),
                                      const outbox::Inbox& inbox = outbox::Inbox::NO_INBOX,
                                      const CryptoFailureCallback& cbFail = [](const apptimate::Exception& e){});
