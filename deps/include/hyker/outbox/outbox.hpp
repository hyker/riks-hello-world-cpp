...
namespace hyker { namespace outbox { class Lifecycle; } }
#include "notifier.hpp"
#include "request.hpp"

// Toolbox++
namespace hyker { class Values; }
 ...
 namespace hyker {
     namespace outbox {
        ...
        public:
            ...
            /**
             * Set hyker developer API keys.
             *
             * @param publicKey public identity of hyker messaging application.
